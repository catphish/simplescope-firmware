...
/* Module Version: 5.7 */
/* /home/charlie/lscc/diamond/3.14/ispfpga/bin/lin64/scuba -w -n pll -lang verilog -synth lse -arch xo2c00 -type pll -fin 120 -fclkop 90 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1  */
...
module pll (CLKI, CLKOP)/* synthesis NGD_DRC_MASK=1 */;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOP="90.000000" */
             /* synthesis FREQUENCY_PIN_CLKI="120.000000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 90.000000
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKI 120.000000
