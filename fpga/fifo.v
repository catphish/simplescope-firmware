...
/* Module Version: 5.8 */
/* /home/charlie/lscc/diamond/3.14/ispfpga/bin/lin64/scuba -w -n fifo -lang verilog -synth lse -bus_exp 7 -bb -arch xo2c00 -type ebfifo -depth 512 -width 32 -rwidth 32 -no_enable -pe 10 -pf 500  */
/* Thu Mar 19 16:29:13 2026 */
...
module fifo (Data, WrClock, RdClock, WrEn, RdEn, Reset, RPReset, Q, 
    ...
    defparam fifo_0_1.FULLPOINTER1 = "0b01111111110000" ;
    defparam fifo_0_1.FULLPOINTER = "0b10000000000000" ;
    defparam fifo_0_1.AFPOINTER1 = "0b01111100110000" ;
    defparam fifo_0_1.AFPOINTER = "0b01111101000000" ;
    defparam fifo_0_1.AEPOINTER1 = "0b00000010110000" ;
    defparam fifo_0_1.AEPOINTER = "0b00000010100000" ;
    defparam fifo_0_1.ASYNC_RESET_RELEASE = "SYNC" ;
    defparam fifo_0_1.GSR = "DISABLED" ;
    defparam fifo_0_1.RESETMODE = "ASYNC" ;
    ...
    defparam fifo_1_0.RESETMODE = "ASYNC" ;
    ...
    FIFO8KB fifo_1_0 (.DI0(Data[18]), .DI1(Data[19]), .DI2(Data[20]), .DI3(Data[21]), 
        ...
        .DI8(Data[26]), .DI9(Data[27]), .DI10(Data[28]), .DI11(Data[29]), 
        .DI12(Data[30]), .DI13(Data[31]), .DI14(scuba_vlo), .DI15(scuba_vlo), 
        ...
        .DO3(Q[30]), .DO4(Q[31]), .DO5(), .DO6(), .DO7(), .DO8(), .DO9(Q[18]), 
        .DO10(Q[19]), .DO11(Q[20]), .DO12(Q[21]), .DO13(Q[22]), .DO14(Q[23]), 
        .DO15(Q[24]), .DO16(Q[25]), .DO17(Q[26]), .EF(), .AEF(), .AFF(), 
        .FF());
