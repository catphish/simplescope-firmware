...
/* Module Version: 5.8 */
/* /home/charlie/lscc/diamond/3.14/ispfpga/bin/lin64/scuba -w -n fifo -lang verilog -synth lse -bus_exp 7 -bb -arch xo2c00 -type ebfifo -depth 1024 -width 32 -rwidth 32 -regout -resetmode ASYNC -reset_rel SYNC -pe 516 -pf 516  */
...
module fifo (Data, WrClock, RdClock, WrEn, RdEn, Reset, RPReset, Q, 
    ...
    defparam fifo_0_3.AFPOINTER1 = "0b01000000011000" ;
    defparam fifo_0_3.AFPOINTER = "0b01000000100000" ;
    defparam fifo_0_3.AEPOINTER1 = "0b01000000101000" ;
    defparam fifo_0_3.AEPOINTER = "0b01000000100000" ;
    ...
    FIFO8KB fifo_0_3 (.DI0(Data[0]), .DI1(Data[1]), .DI2(Data[2]), .DI3(Data[3]), 
        ...
        .DO4(Q[4]), .DO5(Q[5]), .DO6(Q[6]), .DO7(Q[7]), .DO8(Q[8]), .DO9(), 
