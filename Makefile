...
CFILES = main.c usb_cmd.c
CFILES += drv/CH56x_usb30_devbulk.c drv/CH56x_usb20_devbulk.c
CFILES += drv/CH56x_usb_devbulk_desc_cmd.c drv/CH56x_timer.c
CFILES +=drv/CH56x_bsp.c drv/CH56x_gpio.c drv/CH56x_clk.c
